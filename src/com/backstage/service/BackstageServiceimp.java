...
public class BackstageServiceimp implements BackstageService{
	...
	//定时器
	@Override
	public int Backstageskadd(String sknum, String sktime, long sztime) {
		String sql = "INSERT INTO Rushtime(sknum,sktime,sztime) VALUES("+sknum+",'"+sktime+"','"+sztime+"')";
		System.out.println(sql);
		return dao.userupd(sql);
	}

	@Override
	public int Backstageorderisok(String oid) {
		String sql = "UPDATE `Orders` SET Ostate=3 WHERE Oid='"+oid+"'";
		int i = dao.userupd(sql);
		return i;
	}
